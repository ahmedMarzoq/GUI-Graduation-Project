...
public class AddSectionFXMLController implements Initializable {
    ...
    private int spechValue, levelValue;
...
// EndSpam -------------------------------------------------------------------------------------------
    ...
    private void setOptionsCourseComboBox() throws SQLException {
        ObservableList<String> data = FXCollections.observableArrayList(); //List of String
        courseList = getCourses(call, spechValue + 1, levelValue + 1);
...
//                               **** Get Courses ****    
//========================================================================================
    private ArrayList getCourses(DbCall call, int major_id, int level_number) throws SQLException {

        ResultSet resultSet;
        resultSet = call.getExecuteQuery("select * from courses where major_id= " + major_id + " AND level_number = " + level_number);
...
//========================================================================================
    void setSpechLevel(int level, int spech) throws SQLException {
